...
Interface::Interface(RenderWindow* wnd) {
    window=wnd;
    font.loadFromFile("content/minecraft.otf");
    text.setFont(font);
    ...
    hp=100;
    ammo=100;
    menuButton=new SpriteButton(200,30, 1, 400, window, "content/image/arrow.png", 0.2, 0.2);
    add_element(new TextInput(200,30,1,1, "content/minecraft.otf",std::string("HP:") +std::to_string(hp), 50, window,0));
    elements.front()->set_color(51,255,0);
    add_element(new TextInput(200,30,1,100, "content/minecraft.otf",std::string("AM:") +std::to_string(ammo), 50, window,0));
